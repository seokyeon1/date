// 전국 시/도 -> 시/군/구 목록 (좌표는 카카오 로컬 주소 검색 API로 런타임에 조회한다)
...
export function getGuList(sido) {
  return REGIONS[sido] || [];
}

// 하이브리드 입력용 인기 지역 빠른 칩 (시/도 + 구/군을 함께 지정)
export const QUICK_REGIONS = [
  { label: "강남구", sido: "서울특별시", gu: "강남구" },
  { label: "홍대/마포구", sido: "서울특별시", gu: "마포구" },
  { label: "성수동/성동구", sido: "서울특별시", gu: "성동구" },
  { label: "이태원/용산구", sido: "서울특별시", gu: "용산구" },
  { label: "잠실/송파구", sido: "서울특별시", gu: "송파구" },
  { label: "해운대구", sido: "부산광역시", gu: "해운대구" },
];
